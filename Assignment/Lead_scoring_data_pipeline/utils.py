...
def build_dbs(db_path, db_file_name):
    ...
    #if os.path.isfile('C:\Users\revan\Downloads\MLops-PipeLine---MLFlow-and-AirFlow-master\MLops-PipeLine---MLFlow-and-AirFlow-master\Lead_scoring_data_pipeline\AssignmentFolderFiles\scripts')
        print( "DB Already Exist")
        print(os.getcwd())
        return "DB Exist"
    else:
        print ("Revan Creating Database")
        print(os.getcwd())
